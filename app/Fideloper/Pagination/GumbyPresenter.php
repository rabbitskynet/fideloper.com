<?php namespace Fideloper\Pagination;

use Illuminate\Pagination\Paginator;

class GumbyPresenter {
    ...
    /**
     * Create a new Gumby presenter instance.
     *
    ...
    /**
     * Render the Gumby pagination contents.
     *
     * @return string
     */
    ...
    public function getPageRange($start, $end)
    {
        ...
        for ($page = $start; $page <= $end; $page++)
        {
            ...
            // for the link. These views use the "Gumby Framework" styles by default.
            if ($this->currentPage == $page)
            {
                $pages[] = '<li class="primary badge"><a href="#">'.$page.'</a></li>';
            }
            else
            {
    ...
    public function getPrevious($text = 'Prev')
    {
        ...
        {
            return '<li class="light disabled badge"><a href="#">'.$text.'</a></li>';
        }
        else
        {
            $url = $this->paginator->getUrl($this->currentPage - 1);

            return '<li class="default badge"><a href="'.$url.'">'.$text.'</a></li>';
        }
    }
    ...
    {
        return '<li class="light disabled badge"><a href="#">...</a></li>';
    }
