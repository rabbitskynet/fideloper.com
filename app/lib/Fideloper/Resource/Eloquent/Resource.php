...
use Fideloper\Resource\Eloquent\Collection;
use Fideloper\Resource\ResourceInterface;
...
class Resource extends Model implements ResourceInterface  {
    ...
    * @return object  Fideloper\Resource\Eloquent\Model
    */
    ...
    */
     ...
     *
     * @param  array  $models
     * @return Fideloper\Resource\Eloquent\Collection
     */
